    ...
    return (
        <div className="flex items-center justify-between px-40 py-10">
            <div className="">
                ...
                <h2 className="text-3xl">Got skills and want to share
                    with people</h2>
                <button className="bg-black text-white mt-4 border rounded-lg px-3 py-3 text-[12px] ">Start teaching today </button>
            </div>
            <div>
