...
const AddCourse = () => {
  ...
  return (
    <div className=" ">
      ...
      <h2 className="text-2xl text-center">Add your course</h2>


      {/* add course form */}
      <div>
        <form
          className="border border-black mx-80 my-10 py-5 grid justify-center"
        ...
        >
          <div className="grid justify-around gap-5 grid-cols-3">
            ...
            <div>
              <input
                className="border border-black mt-3 ps-3 py-2 rounded-sm text-sm w-60 "
                {...register("email")}
            ...
            <div>
              <input
                className="border border-black mt-3 rounded-sm text-sm w-60 ps-3 py-2 "
            ...
            <div>
              ...
              <div>
                {errors.id && (
                  <p className="text-red-600 text-sm flex">id is required.</p>
                )}
              </div>
            </div>
          ...
          <div className="py-2">
            ...
            <button
              type="button"
              className="text-sm border bg-green-700 rounded-full px-2 py-1 text-white mt-2"
              onClick={() => append()}
            >
              + Add Feature
            </button>
          ...
          {/* submit button */}
          <input
            className="btn btn-neutral mt-3 hover:bg-green-700 hover:text-white"
            type="submit"
          />
        </form>
      </div>
